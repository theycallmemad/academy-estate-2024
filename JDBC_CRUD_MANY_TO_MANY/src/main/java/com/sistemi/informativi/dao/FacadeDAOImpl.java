...
public class FacadeDAOImpl implements FacadeDAO{
    ...
    @Override
    public ArrayList<CustomerVO> getCustomerNameByProduct(int productId) throws ClassNotFoundException, SQLException {

        return customerDAO.getCustomerNameByProduct(productId);
    }
